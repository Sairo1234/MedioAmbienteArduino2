...
void loop() {
  ...
  * mido y publico
  */
  int valorPrueba = elMedidor.medirPrueba(); //aqui se llama al metodo de falsa medición
  
  elPublicador.publicarPrueba(valorPrueba,
                              cont,
                              15000  // intervalo de emisión
  ); //Y se publica el valor falso, se manda en forma de beacon
